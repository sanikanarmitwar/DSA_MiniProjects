...
public:
    void setUp()
    {
        ...
        phone_book->readRecordsFromFile("Details3.txt");
    }
    ...
    {
        runTest([this]()
                { test_add_and_fetch_contact(); }, "test_add_and_fetch_contact");
        runTest([this]()
                { test_add_and_delete_contact(); }, "test_add_and_delete_contact");
        runTest([this]()
                { test_delete_nonexistent_contact(); }, "test_delete_nonexistent_contact");
        runTest([this]()
                { test_fetch_nonexistent_contact(); }, "test_fetch_nonexistent_contact");
        runTest([this]()
                { test_add_multiple_contacts(); }, "test_add_multiple_contacts");
        runTest([this]()
                { test_delete_multiple_contacts(); }, "test_delete_multiple_contacts");
        runTest([this]()
                { test_add_delete_fetch_combination(); }, "test_add_delete_fetch_combination");
        runTest([this]()
                { test_fetch_contacts_with_multiple_words(); }, "test_fetch_contacts_with_multiple_words");
        runTest([this]()
                { test_search_with_middle_name(); }, "test_search_with_middle_name");
        runTest([this]()
                { test_delete_by_middle_name(); }, "test_delete_by_middle_name");
    }
...
private:
    ...
    void test_delete_multiple_contacts()
    {
        ...
        cout << contacts_khanna.size() << endl;
        ...
        if (!(phone_book->deleteContact(new std::string("Ankush Gupta")) && phone_book->deleteContact(new std::string("Aarav Khanna"))))
        {
            ...
            cout << contacts_gupta_after_delete.size() << endl;
            cout << contacts_khanna_after_delete.size() << endl;
